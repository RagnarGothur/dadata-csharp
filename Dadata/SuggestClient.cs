...
namespace Dadata
{
    ...
    public class SuggestClient : ClientBase
    {
        ...
        public async Task<SuggestResponse<Address>> FindAddress(string query)
        {
            ...
            return await ExecutePost<SuggestResponse<Address>>(
        ...
        {
            return await ExecutePost<SuggestResponse<Email>>(
                method: SuggestionsMethod.Suggest,
        ...
        {
            return await ExecutePost<SuggestResponse<Fullname>>(
                method: SuggestionsMethod.Suggest,
        ...
        {
            return await ExecutePost<SuggestResponse<Party>>(
                method: SuggestionsMethod.Find,
